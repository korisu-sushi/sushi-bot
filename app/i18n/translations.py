...
TEXTS = {
    ...
    "btn_asap": {
        "en": "ASAP (within 3 hours)",
        "fr": "Dès que possible (dans les 3 heures)",
        "uk": "Якнайшвидше (протягом 3 годин)",
        "ru": "Как можно скорее (в течении 3 часов)",
    },
    "btn_custom_time": {
        "en": "Choose date/time",
        "fr": "Choisir date/heure",
        "uk": "Обрати дату/час",
        "ru": "Выбрать дату/время",
    },
    "btn_skip": {
        "en": "Skip",
        "fr": "Passer",
    ...
    # ==================== DELIVERY TIMES ====================
    "select_delivery_day": {
        "en": "📅 Select delivery day:",
        "fr": "📅 Sélectionnez le jour de livraison:",
        "uk": "📅 Оберіть день доставки:",
        "ru": "📅 Выберите день доставки:",
    },
    "select_time_slot": {
        "en": "🕐 Select time for {date}:",
        "fr": "🕐 Sélectionnez l'heure pour {date}:",
        "uk": "🕐 Оберіть час на {date}:",
        "ru": "🕐 Выберите время на {date}:",
    },
    "no_available_slots": {
        "en": "No available time slots for today. Please select another day.",
        "fr": "Aucun créneau disponible pour aujourd'hui. Veuillez sélectionner un autre jour.",
        "uk": "Немає доступних слотів на сьогодні. Будь ласка, оберіть інший день.",
        "ru": "На сегодня нет доступных слотов. Пожалуйста, выберите другой день.",
    },
    "today": {
        "en": "Today",
        "fr": "Aujourd'hui",
    ...
    "weekday_mon": {"en": "Mon", "fr": "Lun", "uk": "Пн", "ru": "Пн"},
    "weekday_tue": {"en": "Tue", "fr": "Mar", "uk": "Вт", "ru": "Вт"},
    "weekday_wed": {"en": "Wed", "fr": "Mer", "uk": "Ср", "ru": "Ср"},
    "weekday_thu": {"en": "Thu", "fr": "Jeu", "uk": "Чт", "ru": "Чт"},
    "weekday_fri": {"en": "Fri", "fr": "Ven", "uk": "Пт", "ru": "Пт"},
    "weekday_sat": {"en": "Sat", "fr": "Sam", "uk": "Сб", "ru": "Сб"},
    "weekday_sun": {"en": "Sun", "fr": "Dim", "uk": "Нд", "ru": "Вс"},
    "month_jan": {"en": "Jan", "fr": "jan", "uk": "січ", "ru": "янв"},
    "month_feb": {"en": "Feb", "fr": "fév", "uk": "лют", "ru": "фев"},
    "month_mar": {"en": "Mar", "fr": "mar", "uk": "бер", "ru": "мар"},
    "month_apr": {"en": "Apr", "fr": "avr", "uk": "кві", "ru": "апр"},
    "month_may": {"en": "May", "fr": "mai", "uk": "тра", "ru": "май"},
    "month_jun": {"en": "Jun", "fr": "jun", "uk": "чер", "ru": "июн"},
    "month_jul": {"en": "Jul", "fr": "jul", "uk": "лип", "ru": "июл"},
    "month_aug": {"en": "Aug", "fr": "aoû", "uk": "сер", "ru": "авг"},
    "month_sep": {"en": "Sep", "fr": "sep", "uk": "вер", "ru": "сен"},
    "month_oct": {"en": "Oct", "fr": "oct", "uk": "жов", "ru": "окт"},
    "month_nov": {"en": "Nov", "fr": "nov", "uk": "лис", "ru": "ноя"},
    "month_dec": {"en": "Dec", "fr": "déc", "uk": "гру", "ru": "дек"},
    "delivery_at": {
        "en": "{weekday}, {day} {month} at {time}",
        "fr": "{weekday} {day} {month} à {time}",
        "uk": "{weekday}, {day} {month} о {time}",
