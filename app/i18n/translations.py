...
TEXTS = {
    ...
    "delivery_cost": {
        "en": "💰 Delivery fee: {fee}{currency}\n<i>Free delivery from {threshold}{currency}</i>",
        "fr": "💰 Frais de livraison: {fee}{currency}\n<i>Livraison gratuite à partir de {threshold}{currency}</i>",
        "uk": "💰 Вартість доставки: {fee}{currency}\n<i>Безкоштовна доставка від {threshold}{currency}</i>",
        "ru": "💰 Стоимость доставки: {fee}{currency}\n<i>Бесплатная доставка от {threshold}{currency}</i>",
    },
    ...
    "delivery_fee_info": {
        "en": "\n\n💰 Delivery fee: {fee}€\n<i>Free delivery from {threshold}€</i>",
        "fr": "\n\n💰 Frais de livraison: {fee}€\n<i>Livraison gratuite à partir de {threshold}€</i>",
        "uk": "\n\n💰 Вартість доставки: {fee}€\n<i>Безкоштовна доставка від {threshold}€</i>",
        "ru": "\n\n💰 Стоимость доставки: {fee}€\n<i>Бесплатная доставка от {threshold}€</i>",
    },
    "enter_comment": {
